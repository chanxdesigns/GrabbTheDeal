...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="//cdn.grabbthedeal.in/assets/css/styles.min.20161216124548.css">
    {{--<link rel="stylesheet" type="text/css" href="{{asset('assets/css/versions/styles.min.css/styles.css')}}">--}}
