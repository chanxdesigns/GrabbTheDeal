...
@section('title', 'Redirecting to Deal Page')
@section('content')
    ...
    <div class="container">
        <div class="offer-redirect-wrapper">
            <div class="redirect-header">
                ...
                <p class="header-text pull-right">{{$deal->deal_name}}</p>
            </div>
            <div class="redirect-body">
                <p class="redirect-body-title">PLEASE WAIT</p>
                <h3 class="redirect-text"><span class="span-text">@if (Request::cookie('user_name')) {{explode(' ',Request::cookie('user_name'))[0]}} @else Hello Stranger @endif</span>, You are being redirected to {{$deal->deal_name}}, {{$store->store_name}}</h3>
            ...
            <input type="hidden" id="redirect-deal-id" value="{{$deal->deal_id}}">
        </div>
    </div>
@endsection