...
@section('title', 'Redirecting to Store Page')
@section('content')
    <div class="top-pad"></div>
    <div class="container">
        <div class="store-redirect-wrapper">
            <div class="redirect-header">
                <img class="header-img" src="//cdn.grabbthedeal.in/{{$store->store_logo}}">
            </div>
            ...
            <input type="hidden" id="redirect-store-id" value="{{$store->store_id}}">
        </div>
    </div>
@endsection